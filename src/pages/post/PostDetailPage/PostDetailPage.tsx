            ...
            <div className={styles.authorInfo}>
              ...
              <div>
                ...
                <Typography variant="subtitle2" color="text.secondary">
                    Author: {post.userInfo?.firstName} {post.userInfo?.lastName} • Posted: {formatDate(post.createdAt)} • Updated: {formatDate(post.updatedAt)} 
                </Typography>
                <Typography variant="caption" color="text.secondary">
                  Wiews {post.viewCount} • Replies {post.replyCount}
                </Typography>
              </div>
            </div>
          </div>
                ...
                {reply.subReplies && reply.subReplies.length > 0 && (
                  <div className={styles.subReplies}>
                    {reply.subReplies.map((subReply) => (
                      <div key={subReply.id} className={styles.subReply}>
                        <Avatar className={styles.subReplyAvatar}>
                          {subReply.userInfo?.firstName?.charAt(0) ?? '?'}
                        </Avatar>
                        <div className={styles.subReplyContent}>
                          <Typography variant="subtitle2" fontWeight={500}>
                            {subReply.userInfo?.firstName} {subReply.userInfo?.lastName}
                          </Typography>
                          <Typography variant="caption" color="text.secondary">
