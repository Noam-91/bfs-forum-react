...
interface PostProps {
    ...
    left2?: 'author'|'replyCount'|'createdAt'|'viewCount'|'viewAt' | null;
...
const PostItem = ({ post, left0, left1, left2, right, viewAt}:PostProps) => {
    const author =post.userInfo && post.userInfo.firstName && post.userInfo.firstName?
      ...
      >
          <div className={styles.postContent}>
              ...
              <div className={styles.postMeta}>
                  ...
                  •
                  {left2 != null && (<span>{infoMap[left2]}</span>)}
